...
def plot_frame(ax, R, o, label, length=0.5):
    ...
    ax.quiver(o[0], o[1], o[2], x_axis[0]-o[0], y_axis[1] - o[1], y_axis[2] - o[2], color='g', arrow_length_ratio = 0.1)
...
if __name__=="__main__":
    ...
    #subplot1
    ax1 = fig.add_subplot(121,projections='3d')
    ...
    ter(p_world[0], p_world[1], p_world[2], color='orange', length=1)
    ax2.set_title("World Frame and p transformated")
    ax2.set_xlim(-1,4)
    ax2.set_ylim(-1,4)  
    ax2.set_zlim(0,6)
    ax2.legend()
